...
#ifndef plugin_templateFXParams_H
#define plugin_templateFXParams_H
...
struct plugin_templateRTPCParams
{
    AkReal32 fDummy;
};

struct plugin_templateNonRTPCParams
{
};

struct plugin_templateFXParams
    : public AK::IAkPluginParam
{
    plugin_templateFXParams();
    plugin_templateFXParams(const plugin_templateFXParams& in_rParams);
    ...
    plugin_templateRTPCParams RTPC;
    plugin_templateNonRTPCParams NonRTPC;
} AK_ALIGN_DMA;

#endif // plugin_templateFXParams_H
